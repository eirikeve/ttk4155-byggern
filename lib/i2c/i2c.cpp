...
// union I2CStatusReg I2CStatusReg = {0};            // I2CStatusReg is defined in TWI_Master.h
...
// ****************************************************************************/
// unsigned char I2C::transceiverBusy( void )
// {
...
// ****************************************************************************/
// unsigned char I2C::getStateInfo( void )
// {
//   while (this->tranceiverBusy() );             // Wait until TWI has completed the transmission.
...
// ****************************************************************************/
// void I2C::startTransceiverWithData( unsigned char *msg, unsigned char msgSize )
// {
//   unsigned char temp;

//   while (this->tranceiverBusy() );             // Wait until TWI is ready for next transmission.
...
// then initialize the next operation and return.
// ****************************************************************************/
// void I2C::startTransceiver( void )
// {
//   while (this->tranceiverBusy() );             // Wait until TWI is ready for next transmission.
//   I2CStatusReg.all = 0;      
//   TWI_state         = TWI_NO_STATE ;
...
// startTransceiver to send a request for data to the slave. Then Run this function to collect the
// data when they have arrived. Include a pointer to where to place the data and the number of bytes
// requested (including the address field) in the function call. The function will hold execution (loop)
// until the TWI_ISR has completed with the previous operation, before reading out the data and returning.
// If there was an error in the previous transmission the function will return the TWI error code.
// ****************************************************************************/
// unsigned char I2C::getDataFromTransceiver( unsigned char *msg, unsigned char msgSize )
// {
//   unsigned char i;
